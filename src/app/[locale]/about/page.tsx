...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "About Us — AABP",
    description:
      "Learn about the Association of Azerbaijan British Professionals — our mission, vision, leadership, and journey connecting professionals across five key disciplines.",
  },
};
